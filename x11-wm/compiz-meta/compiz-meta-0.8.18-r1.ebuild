...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="boxmenu +ccsm debugutils +emerald full -fusionicon +fusionicon2 manager +plugins simpleccsm"

RDEPEND="
	plugins? ( >=x11-plugins/compiz-plugins-meta-${PV} )
	...
	fusionicon2? ( >=x11-misc/fusion-icon2-0.1 )
	manager? ( >=x11-apps/compiz-manager-0.7.0 )
	simpleccsm? ( >=x11-misc/simple-ccsm-0.8.14.1 )
"
REQUIRED_USE="full? ( boxmenu ccsm debugutils emerald fusionicon fusionicon2 manager simpleccsm plugins )"
