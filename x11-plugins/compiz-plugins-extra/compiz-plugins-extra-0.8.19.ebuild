...
DESCRIPTION="Compiz Window Manager: Extra Plugins (with 3D performance fix)"
HOMEPAGE="https://gitlab.com/compiz"
SRC_URI="https://gitlab.com/compiz/${PN}/uploads/b53eb95252331d53b42231778f55de44/${PN}-0.8.18.tar.xz -> ${P}.tar.xz"
